#############################################################################
# Makefile for building: Open
# Generated by qmake (3.1) (Qt 5.15.0)
# Project:  Open.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Open.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Open1.0.0
DISTDIR = /home/dude/Open/.tmp/Open1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lX11 -lXtst -lImlib2 -lXcomposite -lXrender -lXfixes -lXdamage -lXi -lcairo /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: Open.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Cloud.hpp skyItem.hpp Sky.hpp dataStructuers.hpp Common.hpp skyScope.hpp skyNotifier.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp Cloud.cpp skyItem.cpp Sky.cpp dataStructuers.cpp skyScope.cpp Sky-events.cpp Sky-clouds.cpp Sky-ease.cpp skyNotifier.cpp $(DISTDIR)/
...
skyItem.o: skyItem.cpp skyItem.hpp \
		Common.hpp \
		dataStructuers.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o skyItem.o skyItem.cpp

Sky.o: Sky.cpp Sky.hpp \
		Common.hpp \
		dataStructuers.hpp \
		Cloud.hpp \
		skyItem.hpp \
...
dataStructuers.o: dataStructuers.cpp dataStructuers.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dataStructuers.o dataStructuers.cpp

skyScope.o: skyScope.cpp skyScope.hpp \
		Common.hpp \
		dataStructuers.hpp \
		Sky.hpp \
		Cloud.hpp \
		...
		scopeBrowser.hpp \
		skyNotifier.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o skyScope.o skyScope.cpp

Sky-events.o: Sky-events.cpp Sky.hpp \
		Common.hpp \
		dataStructuers.hpp \
		Cloud.hpp \
		skyItem.hpp \
		...
		skyScope.hpp \
		skyNotifier.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Sky-events.o Sky-events.cpp

Sky-clouds.o: Sky-clouds.cpp Sky.hpp \
		Common.hpp \
		dataStructuers.hpp \
		Cloud.hpp \
		skyItem.hpp \
		...
		skyScope.hpp \
		skyNotifier.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Sky-clouds.o Sky-clouds.cpp

Sky-ease.o: Sky-ease.cpp Sky.hpp \
		Common.hpp \
		dataStructuers.hpp \
		Cloud.hpp \
		skyItem.hpp \
		...
		skyScope.hpp \
		skyNotifier.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Sky-ease.o Sky-ease.cpp

skyNotifier.o: skyNotifier.cpp skyNotifier.hpp \
		Common.hpp \
		dataStructuers.hpp \
		Sky.hpp \
		Cloud.hpp \
		...
		scopeBrowser.hpp \
		skyScope.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o skyNotifier.o skyNotifier.cpp
